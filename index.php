...
//Abrimos elarchivo solo lectura
$abre = fopen($archivo,"r");

//obtenemoselvaloractualdevisitas
$total = fread($abre,filesize($archivo));

//Cerramos la conexiónal archivo
fclose($abre);

//Abrimosnuevamenteelarchivo
$abre = fopen($archivo,"w");
//Sumamos1 nueva visita
$total = $total+1;
//Y reemplazamos por la nueva cantidad
$grabar = fwrite ($abre,$total);
//Cerramoslaconexiónalarchivo
fclose($abre);
//Imprimimostotaldevisitas
echo"<td width='400'> <fontface='Kristen ITC'size='3'><fontcolor='#FFFFFF'><div align='right'>Visitas:<fontcolor='#FFFFFF'>".$total."</font></td>";
?> 
